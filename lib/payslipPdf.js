...
export function buildPayslipRun({ saved, dailyRate = 0, absenceDays = 0, periodLabel = '' }) {
  ...
  const grossPay = basic + incentives + overtime + refund
  ...
  return { basic, incentives, overtime, refund, grossPay, sss, philhealth, pagibig, tax, totalGovDeductions, late, undertime, absence, totalAttendance, netPay, periodLabel }
}
